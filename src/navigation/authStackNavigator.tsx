...
> = useNavigation();
    ...
    const getSigninNavigator = () => {
        return (
            <TouchableOpacity onPress={() => navigation.navigate("SigninScreen")} style={{ backgroundColor: colors.lavenderColor, alignItems:"center", justifyContent:"center", borderRadius: 15, paddingHorizontal: 15, paddingVertical: 10 }}>
               <TextComponent style={{fontSize: 16, color: colors.primaryColor}} weight="bold"> Sign-In</TextComponent>
            </TouchableOpacity>
        )
    }
  return (
